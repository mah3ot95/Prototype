package il.ac.haifa.Prototype.ocsf;
...
import il.ac.haifa.Prototype.App;
import il.ac.haifa.Prototype.Question;
import il.ac.haifa.Prototype.ocsf.server.AbstractServer;
import il.ac.haifa.Prototype.ocsf.server.ConnectionToClient;
...
public class Server extends AbstractServer {
	...
	private static void createSession() {
		...
		try {
			...
			generateDatabese();
			System.out.println("after generating database");
	...
	private static SessionFactory getSessionFactory() throws HibernateException {
	 	 ...
	 	 System.out.println("condifuration getproperties: " + configuration.getProperties());
